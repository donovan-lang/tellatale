...
export default function HeroGenerator() {
  ...
  return (
    <div className="animate-fade-up animate-fade-up-delay-3 mt-10 max-w-xl mx-auto">
      <div className="flex flex-col sm:flex-row gap-2 bg-white/10 dark:bg-gray-900/60 backdrop-blur-sm border border-gray-200/30 dark:border-gray-700/40 rounded-2xl p-2 shadow-xl shadow-purple-500/10">
        <input
          type="text"
          value={idea}
          ...
          className="flex-1 bg-transparent px-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 outline-none min-w-0"
          maxLength={200}
        />
        <button
          onClick={go}
          className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-purple-600 to-brand-600 hover:from-purple-500 hover:to-brand-500 transition-all shadow-lg shadow-purple-500/20 hover:shadow-purple-500/30 shrink-0 text-sm"
        >
          <Sparkles size={16} />
          Generate
        </button>
